...
sed -i 's/IMG_PREFIX:=/IMG_PREFIX:=$(BUILD_DATE_PREFIX)-5.15-/g' ./include/image.mk
...
sed -i "s/\"http:/window.location.protocol+\"/g" ./feeds/luci/luci-app-netdata/luasrc/view/netdata/netdata.htm
